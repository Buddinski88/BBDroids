...
static const char*         DROID_NAME = "Buddys D-O";
static const uint8_t       BUILDER_ID = 6; // Reserved values: 0 Bjoern, 1 Felix, 2 Micke, 3 Brad, 4 Lars, 5 Lukas, 6 Buddy
static const uint8_t       DROID_ID   = 1;
